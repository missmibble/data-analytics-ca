...
_INDICATOR_CONTEXT = (
    ...
    "'Mortgage rate - 1 year', 'Mortgage rate - 3 year', 'Mortgage rate - 5 year', "
    "'Mortgage delinquency rate', "
    "'HELOC delinquency rate', 'Credit card delinquency rate', "
    "'Auto loan delinquency rate', 'LOC delinquency rate', "
    "'Avg credit score - Without mortgage', 'Avg credit score - With mortgage', "
    "'Avg credit score - With new mortgage', "
    "'Avg monthly mortgage payment - Existing', 'Avg monthly mortgage payment - New'. "
    "Note: mortgage rates, delinquency rates (except Mortgage delinquency rate which also has "
    "Montreal/Toronto/Vancouver), credit scores, and payment data are national — "
    "use geography 'Canada'. Delinquency and credit data are quarterly; filter dim_date "
    "with month IN (3, 6, 9, 12) for quarterly series. "
    "Data storage rules: "
